...
>
  <div class="space-y-4">
    ...
    <div>
      ...
      <div class="flex gap-2">
        <button
          ...
          class="flex-1 px-4 py-2 rounded-sm border transition-colors text-sm font-medium
            {mode === 'FromImage'
              ? 'bg-[var(--color-neon)] border-[var(--color-neon)] text-white'
              : 'bg-[var(--color-surface)] border-[var(--color-surface)] hover:border-[var(--color-neon)]/50'}"
        >
          From Image
        </button>
        <button
      ...
      <div class="space-y-4">
        ...
        <div>
          <label for="qs-image-prompt" class="block text-sm font-medium mb-1">
            Image Prompt <span class="text-[var(--color-destructive)]">*</span>
          </label>
          <textarea
            id="qs-image-prompt"
    ...
    <div>
      <label for="qs-motion-prompt" class="block text-sm font-medium mb-1">
        Motion Prompt <span class="text-[var(--color-destructive)]">*</span>
      </label>
      <textarea
        id="qs-motion-prompt"
  ...
  {#snippet footer()}
    ...
    <Button onclick={handleGenerate} disabled={loading || (mode === 'FromImage' && !selectedAssetId) || (mode === 'FromPrompt' && !imagePrompt.trim()) || !motionPrompt.trim()}>
